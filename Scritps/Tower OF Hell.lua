...
local w = library:CreateWindow("Tower OF Hell") -- Creates the window

local b = w:CreateFolder("Freatures") -- Creates the folder(U will put here your buttons,etc)

b:Label("Recommended To Use INF-JUMP And 150 JUMPPower",{
...
b:Button("Remove Anti-cheat",function ()
...
local Player = w:CreateFolder("Local Player")
...
Credits:Label("XShub.Devs",{
    TextSize = 15;
    TextColor = Color3.fromRGB(255,255,255); 
    BgColor = Color3.fromRGB(43, 43, 43);
})
Credits:Label("https://discord.gg/5aausdPbtQ",{
    TextSize = 17;
    TextColor = Color3.fromRGB(255,255,255);
    BgColor = Color3.fromRGB(43, 43, 43);
}) 
