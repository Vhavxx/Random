...
function Flux:Window(text, bottom,mainclr)
	...
	function Tabs:Tab(text,ico)
		...
		function ContainerContent:AddButton(text, desc, callback)
			if desc == "" then
		...
		function ContainerContent:AddToggle(text, desc,default, callback)
		...
		function ContainerContent:AddSlider(text,desc,min,max,start,callback)
			local SliderFunc = {}
		...
		function ContainerContent:AddDropdown(text,list,callback)
			local DropFunc = {}
			local Selected = text
			local FrameSize = 43
			local ItemCount = 0
		...
		function ContainerContent:AddColorpicker(text,preset,callback)
		...
		function ContainerContent:AddLine(color)
		...
		function ContainerContent:AddLabel(text)
		...
		function ContainerContent:AddTextbox(text,desc,disapper,callback)
			if desc == "" then
		...
		function ContainerContent:AddBind(text,presetbind,callback)
